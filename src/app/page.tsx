...
export default async function HomePage() {
  ...
  const displaySubjects = subjects || [
    ...
    { id: '4', name: 'Tax', code: 'TAX', slug: 'tax', description: 'Income tax principles, corporate tax, withholding tax, VAT rules, and tax computation.', exam_configs: [{ duration_minutes: 90, total_marks: 100, mcq_count: 35 }] },
